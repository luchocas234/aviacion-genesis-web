  ...
  return (
    <div className="w-full h-full relative ">
      <div className="h-full w-full relative justify-center items-center flex">
        ...
        <div className=" absolute  w-[90%] h-full top-0 flex z-10 justify-center items-center flex-col  text-center text-white/80">
          <h1 className="text-5xl lg:text-7xl font-bold">
            Se el piloto que soñaste ser
          </h1>

          <BiDownArrow className="text-center text-4xl mt-32 animate-bounce" />
        </div>
      ...
      <div className="flex items-center  w-full h-full lg:h-[90vh] justify-center flex-col relative p-4">
        ...
        >
          ...
          <div
            data-aos="fade-left"
            data-hidden="true"
            className=" col-span-1 text-center    flex flex-col justify-between items-center"
          >
