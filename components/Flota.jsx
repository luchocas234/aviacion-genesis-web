        ...
        <div className="w-full  grid justify-center items-center lg:grid-cols-3 gap-6 ">
          ...
          <div className="max-w-md col-span-3 lg:col-span-1 bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
            ...
            <div className="p-5">
              ...
              <a
                href="#"
                className="inline-flex items-center py-2 px-3 text-sm font-medium text-center text-white  rounded-lg hover:bg-slate-600 focus:ring-4 focus:outline-none focus:ring-orange-300 bg-orange-400"
              >
                Read more
                <svg
